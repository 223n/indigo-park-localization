...
エンディングの歌詞の訳を字幕で出すため、MOD用の道具[UE4SS](https://github.com/UE4SS-RE/RE-UE4SS)を、  
ゲームの実行ファイルのフォルダー（`RaccoonCh1\Binaries\Win64`）に置きます。
...
| ドキュメント     | 文書の追加や修正                                  | ラベラー、人間                   |
| 翻訳             | 訳文の追加や修正                                  | Issueフォーム、ラベラー          |
| 質問             | 使い方や仕様についての質問                        | Issueフォーム                    |
| アクセシビリティ | 障害のある人の利用を妨げるもの                    | 人間                             |
| 重複             | すでにあるIssueやPull Requestと同じ内容           | 人間                             |
| 無効             | 内容が正しくない、または対象外                    | 人間                             |
| 対応しない       | 対応しないと判断したもの                          | 人間                             |
| 初心者向け       | はじめて貢献する人に向く課題                      | 人間                             |
| 助けが必要       | 手を貸してほしい課題                              | 人間                             |
...
| 自動公開         | このPull Requestをマージしたら、Releaseを公開する | リリースのワークフロー、人間     |
| セキュリティ     | 脆弱性やセキュリティに関わる修正                  | 人間、ラベラー                   |
| 破壊的変更       | 後方互換性を壊す変更                              | 人間                             |
...
| Contents          | Read and write。Pull Requestのマージに必要です                               |
| Pull requests     | Read and write。Pull Requestの作成に必要です                                 |
| Workflows         | Read and write。ワークフローのファイルを変えるPull Requestのマージに必要です |
...
セルフホストのランナーには、`git`と`gh`（GitHub CLI）、Dockerが必要です。  
